...
namespace problem_833 {

inline std::string find_replace_string(std::string& S, std::vector<int>& indexes, std::vector<std::string>& sources, std::vector<std::string>& targets) {
